        ...
        <div className="text-center space-y-8 mb-16">
          <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
            <DialogTrigger asChild>
              <Button 
                size="lg" 
                className="text-2xl h-20 px-16 gradient-bg text-white border-none font-bold shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105"
              >
                      ...
                      <Card key={index} className="border-0 shadow-lg bg-background/60 backdrop-blur-sm">
                        <CardContent className="p-6 text-center">
                          <div className="space-y-4">
                            <div className={`flex h-12 w-12 items-center justify-center rounded-2xl ${highlight.bgColor} mx-auto`}>
                  ...
                  <div className="text-center space-y-8">
                    ...
                    <div className="flex flex-col space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0 justify-center">
                      <Button size="lg" className="text-xl h-16 px-12 gradient-bg text-white border-none" asChild>
                        <Link href="/learn-earn" onClick={() => setIsModalOpen(false)}>
                      ...
                      <Button size="lg" variant="outline" className="text-xl h-16 px-8 border-2" asChild>
                        <Link href="/learn-earn#learn-more" onClick={() => setIsModalOpen(false)}>
                          Learn More
                        </Link>
                      </Button>
                    </div>
